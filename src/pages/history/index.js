      ...
      <PageLayout>
        ...
        <LeftSide>
          <div className={styles.left_container}>
            ...
            <p>
              NOTE: History is a compilation of historical events, most history
              is passed down legendary information, as seen from various
              perspectives, some are documented information passed down through
              writings or first hand eye witnesses. This information has been
              the results of first hand eye witnesses, and original creators and
              ...
              to produce its foundation ..Read and Enjoy
            </p>
          </div>
        </LeftSide>
        <RightSide>
        ...
        <LeftSide>
          <div className={styles.left_container}>
            ...
            <p>
              ...
              Robot, Slim Robot and Sambo Lock. They were called The “
              Campbellock Dancers“.
            </p>
          </div>
        </LeftSide>
        <RightSide>
          <div className={styles.right_container}>
            <p>
              Don Campbell along with dancers like Greg “Campbell Jr” Pope,
              Jimmy “Scooby doo” Foster, Fred “Mr. Penguin” Berry ( AKA
              Rerun),Damita Jo Freeman, The Go-Go- Brothers (Tony Lewis and
              Edwin “Buddy” Lombard),Kevin “YoYo”Lombard, James “Skeeter Rabbit”
              Higgins, Leo “Fluky Luke” Williamson, Johnny “Sambo Lock”
              McCloud,Damita Jo Freeman, Charles “Robot” Washington, Bill “Slim
              Robot” Williams, Alpha Anderson, Fredie Maxie, Guy “Shocklock”
              Evans, Tito Collins, Jeffery Daniels, Arnetta “Netta Bug” Johnson.
              Eugine “F & M Henderson and SEVERAL other old school originals
              would meet in nightclubs like, ” The Citadel” in Hollywood, The
              Summit on the Hill or Mavericks Flats and share steps and moves.
              after the initial years locking when began to grow, Dancers like
              Adolfo “Shabba doo” Quinones , Hayword “Tito Collins , Mike “Peek
              a boo” Frenke and Freddi Maxie and a few Others joined the
              original club scene
            </p>
          </div>
        </RightSide>
        ...
        <RightSide>
          <div className={styles.left_container}>
            <p>
              During that era & time, Greg Campbell Jr. Pope “Scooby doo”
              Foster, “, along with the GoGo ,YoYo CoCo brothers Family of Tony
              and Buddy Go-Go and Skeeter Rabbit, Arnetta Johnson . Kevin “yoYo”
              Lombard. sometimes partying with Leo “Fluky Luke” Williamson &
              Fred Berry at house parties, high schools , picniks and social
              events creating steps that were performed in unison. A movement
              towards group dancing was taking place in Watts,Compton & South
              Central, Los Angeles.and then continued interacting with other
              street dancers Like Greg “Captain Crunch” Dandridge & Steve
              “Sinbad Crane” This was evolution of the STREET MOVEMENT OF
              LOCKING
            </p>
          </div>
        </RightSide>
